...
<body>
<%System.out.println("I'm in admin login"); %>
<h2 align="center"><font color="blue">Admin Login</font></h2>
...
<center><input type="submit" name="adminlogin" value="Login" > <a href="#" class=" icon arrow"></a></center>                                                                                                                                                                                                                       </h4>
</form>
</body>
</html>